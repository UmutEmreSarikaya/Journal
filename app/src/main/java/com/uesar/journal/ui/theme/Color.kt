...
val PrimaryContainer = Color(0xFF578CFF)
...
val StressedGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFF69193), Color(0xFFED3A3A))
)
val SadGradient = Brush.linearGradient(
    colors = listOf(Color(0xFF7BBCFA), Color(0xFF2993F7))
)
val NeutralGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFC4F3DB), Color(0xFF71EBAC))
)
val PeacefulGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFFCCDEE), Color(0xFFF991E0))
)
val ExcitedGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFF5CB6F), Color(0xFFF6B01A))
)
val BGGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFD9E2FF).copy(alpha = 0.4f), Color(0xFFEEF0FF).copy(alpha = 0.4f))
)
val BGSaturatedGradient = Brush.linearGradient(
    colors = listOf(Color(0xFFD9E2FF), Color(0xFFEEF0FF))
)
